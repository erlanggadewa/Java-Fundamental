...
public class LoopingBersarang {
    ...
    public static void main(String[] args) {
        ...
        while (a <= 7) { // menggunakan while atau for tidak berpengaruh karena tidak ada break yg bisa
                         // skip perubahan data
            System.out.print("loop ke " + a + "      ");
            for (int b = 1; b <= 7;) { // Menggunakan for karena for mereset nilai kembali ke 1 tidak meneruskan
                                       // perubahan
                System.out.print("*  ");
                if (a == b) {
                    break;
