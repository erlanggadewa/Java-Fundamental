...
public class OperasiArray {
    ...
    public static void main(String[] args) {
        ...
        int[] arrayAngka3 = new int[arrayAngka2.length]; // ! memerlukan dimensi karena kita tidak meggunakan fungsi
                                                         // pada java.util.Arrays untuk melakukan operasi
        ...
        int[] arrayAngka5; // ! tidak perlu mengisi dimensi karena menggunakan Arrays.copyOf yang akan
        ...
        // ! operator untuk mengisi nilai array yang kosong dengan nilai yang kita
        // inginkan
        ...
        System.out.println(
                "Komparasi array ke-10 terhadap array ke-11 = " + Arrays.compare(arrayAngka10, arrayAngka11) + "\n");
        ...
        System.out.println(
                "Komparasi array ke-12 terhadap array ke-13 = " + Arrays.compare(arrayAngka12, arrayAngka13) + "\n");
        // ! mengecek array yang berbeda
        ...
        System.out
                .println("Komparasi array ke-14 terhadap array ke-15 = " + Arrays.compare(arrayAngka14, arrayAngka15));
        // ! keterangan
        System.out.println(
        ...
        // ! NB : Walaupun pada arrayAngka24 dan arrayAngka25 memiliki perbedaan pada
        // ! index 2 dan 3 , tetapi hasilnya berbeda pada index 2 karena yg dicari
        // ! merupakan yg berbeda pertama
        ...
        if ((Arrays.binarySearch(arrayAngka26, inputArray) < arrayAngka26.length)
                && (Arrays.binarySearch(arrayAngka26, inputArray) >= 1)) {
            System.out.println("Angka " + inputArray + " pada array di atas berada pada index = "
                    + Arrays.binarySearch(arrayAngka26, inputArray));
        } else {
